...
- `manage_users.py` — create accounts, set passwords, enable/disable sign-in. Use `set-password legacy@nutrimind.invalid` to claim data that existed before accounts did.
